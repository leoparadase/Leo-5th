...
BEGIN_MESSAGE_MAP(CSotnikov3App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSotnikov3App::OnAppAbout)
...
// Создание CSotnikov3App

CSotnikov3App::CSotnikov3App() noexcept
{

	// TODO: замените ниже строку идентификатора приложения строкой уникального идентификатора; рекомендуемый
	// формат для строки: ИмяКомпании.ИмяПродукта.СубПродукт.СведенияОВерсии
	SetAppID(_T("Sotnikov3.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSotnikov3App

CSotnikov3App theApp;


// Инициализация CSotnikov3App

BOOL CSotnikov3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CSotnikov3Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CSotnikov3View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CSotnikov3App
